...
export class BlogsComponent {
  categories: string[] = ['All', 'Furniture & Decor', 'office', 'smart home','Home Decor','Dining Furniture','Bedroom Furniture','Vintage','Small Spaces','Outdoor Living','Wooden',''];
  ...
  goToPage(page: number): void {
    ...
    get filteredPosts(): BlogPost[] {
      return this.posts.filter(post =>
        ...
        (this.searchQuery === '' || post.title.toLowerCase().includes(this.searchQuery.toLowerCase()))
      );
    }
